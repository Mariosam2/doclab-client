...
const Toolbar = ({ editor }: ToolbarProps) => {
  ...
  return (
    <div className="flex items-center">
      <NavLink to="/dashboard/documents" className="bg-c-electric-violet p-2">
        <ArrowLeft className="size-6 text-sky-50 stroke-2" />
      </NavLink>
      <div className="flex items-center gap-1 border-b sticky top-0 bg-white z-10 flex-wrap p-2">
